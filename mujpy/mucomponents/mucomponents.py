...
class mumodel(object):
    ...
    # _available_components_ automagically lists them all
    ...
    def _rebin_plot_(self,tup,lastfits):
        ...
        if self._calib:
            ...
            x, yf, eyf = rebin (self._t_,yf,[self._start_,self._stop_],self._pack_,e=eyf)
            ...
            x, yb, eyb = rebin (self._t_,yb,[self._start_,self._stop_],self._pack_,e=eyb)
